...
const DEFAULT_GENRES = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id:11, type:"kizyutsu", title:"Q11", text:"雲雀恭弥の口癖として有名な、規則違反者に向けて言う言葉は？",             media:null, audio:null, answer:"咬み殺す",       answers:"咬み殺す,かみころす,咬み殺すよ,かみころすよ",                             nagaoType:"未分類", explanation:null },
      { id:12, type:"kizyutsu", title:"Q12", text:"雲雀恭弥が連れている小動物の名前は？",                           media:null, audio:null, answer:"ヒバード",     answers:"ヒバード,ひばーど",                                      nagaoType:"未分類", explanation:null },
      { id:13, type:"kizyutsu", title:"Q13", text:"綱吉をツナ君（またはツっ君）と呼ぶでヒロイン的存在の女の子の名前は？",                       media:null, audio:null, answer:"笹川京子",         answers:"笹川京子,ささがわきょうこ,京子,きょうこ",                       nagaoType:"未分類", explanation:null },
      { id:14, type:"kizyutsu", title:"Q14", text:"綱吉の使用する武器は？",                 media:null, audio:null, answer:"グローブ", answers:"グローブ,ぐろーぶ",                    nagaoType:"未分類", explanation:null },
      { id:17, type:"kizyutsu", title:"Q17", text:"リボーンが主に銃に変身させる、緑色の爬虫類の相棒の名前は？",                       media:null, audio:null, answer:"レオン",         answers:"レオン,れおん",                                          nagaoType:"未分類", explanation:null },
      { id:18, type:"kizyutsu", title:"Q18", text:"未来編で登場する、ボンゴレ十代目ファミリーの敵となる組織の名前は？",   media:null, audio:null, answer:"ミルフィオーレファミリー", answers:"ミルフィオーレファミリー,ミルフィオーレ",       nagaoType:"未分類", explanation:null },
      { id:19, type:"kizyutsu", title:"Q19", text:"未来編のボスである、大空のマーレリングを所持する人物の名前は？",                               media:null, audio:null, answer:"白蘭",       answers:"白蘭,びゃくらん", nagaoType:"未分類", explanation:null },
      ...
      { id:27, type:"kizyutsu", title:"Q27", text:"ボンゴレ守護者「雲」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"雲雀恭弥",       answers:"雲雀恭弥,ひばりきょうや,雲雀",                   nagaoType:"未分類", explanation:null },
      { id:28, type:"kizyutsu", title:"Q28", text:"ボンゴレ守護者「嵐」の役割を担うキャラクターは誰？",                 media:null, audio:null, answer:"獄寺隼人",       answers:"獄寺隼人,ごくでらはやと",                        nagaoType:"未分類", explanation:null },
      { id:29, type:"kizyutsu", title:"Q29", text:"ボンゴレ守護者「雨」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"山本武",         answers:"山本武,やまもとたけし",                          nagaoType:"未分類", explanation:null },
      { id:65, type:"kizyutsu", title:"Q65", text:"ボンゴレ守護者「晴」の役割を担うキャラクターは誰？",                         media:null, audio:null, answer:"笹川了平",       answers:"笹川了平,ささがわりょうへい,了平",               nagaoType:"未分類", explanation:null },
      { id:30, type:"kizyutsu", title:"Q30", text:"ボンゴレ守護者「雷」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"ランボ",         answers:"ランボ",                                          nagaoType:"未分類", explanation:null },
      { id:31, type:"kizyutsu", title:"Q31", text:"ボンゴレ守護者「霧」の役割を担う男性キャラクターは誰？", media:null, audio:null, answer:"六道骸",         answers:"六道骸,ろくどうむくろ,骸",                       nagaoType:"未分類", explanation:null },
      ...
      { id:33, type:"kizyutsu", title:"Q33", text:"クローム髑髏の本名は？（苗字不明）",                 media:null, audio:null, answer:"凪",   answers:"凪,なぎ",           nagaoType:"未分類", explanation:null },
      { id:34, type:"kizyutsu", title:"Q34", text:"ボンゴレ守護者「嵐」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"獄寺隼人",       answers:"獄寺隼人,ごくでらはやと",                        nagaoType:"未分類", explanation:null },
      { id:35, type:"kizyutsu", title:"Q35", text:"特殊暗殺部隊ヴァリアーのボスの名前は？",   media:null, audio:null, answer:"ザンザス",       answers:"ザンザス,ざんざす",                                        nagaoType:"未分類", explanation:null },
      { id:36, type:"kizyutsu", title:"Q36", text:"綱吉たちが所属する中学校の名前は？",                                     media:null, audio:null, answer:"並盛中学", answers:"並盛中学,並盛,なみもり",             nagaoType:"未分類", explanation:null },
      { id:40, type:"kizyutsu", title:"Q40", text:"未来編で登場する、綱吉が最初に出会った女性の名前は？",                     media:null, audio:null, answer:"ラル・ミルチ",         answers:"ラル・ミルチ,ラルミルチ",                                          nagaoType:"未分類", explanation:null },
      { id:42, type:"kizyutsu", title:"Q42", text:"キャバッローネファミリーのディーノの二つ名は？",                 media:null, audio:null, answer:"跳ね馬",       answers:"跳ね馬,はね馬,はねうま",                                        nagaoType:"未分類", explanation:null },
      { id:43, type:"kizyutsu", title:"Q43", text:"ディーノの側近の名前は？",                         media:null, audio:null, answer:"ロマーリオ",       answers:"ロマーリオ,ろまーりお",                                        nagaoType:"未分類", explanation:null },
      { id:48, type:"kizyutsu", title:"Q48", text:"世界を保つための21個の至宝（ボンゴレリング、マーレリング、アルコバレーノのおしゃぶり）の総称は？", media:null, audio:null, answer:"7³（トゥリニセッテ）",       answers:"7³,トゥリニセッテ",                            nagaoType:"未分類", explanation:null },
      ...
      { id:52, type:"kizyutsu", title:"Q52", text:"初代ボンゴレファミリーで雲の守護者を務めた人物の名前は？",                 media:null, audio:null, answer:"アラウディ",             answers:"アラウディ",                                          nagaoType:"未分類", explanation:null },
      ...
      { id:53, type:"kizyutsu", title:"Q53", text:"初代ボンゴレファミリーで雨の守護者を務めた人物の名前は？",                 media:null, audio:null, answer:"朝利雨月", answers:"朝利雨月,アサリ・ウゲツ,アサリ,雨月,あさりうげつ",                          nagaoType:"未分類", explanation:null },
      { id:54, type:"kizyutsu", title:"Q54", text:"初代ボンゴレファミリーで晴の守護者を務めた人物の名前は？",               media:null, audio:null, answer:"ナックル",       answers:"ナックル",                                        nagaoType:"未分類", explanation:null },
      { id:55, type:"kizyutsu", title:"Q55", text:"初代ボンゴレファミリーで雷の守護者を務めた人物の名前は？",                 media:null, audio:null, answer:"ランポウ",         answers:"ランポウ",                                          nagaoType:"未分類", explanation:null },
      { id:56, type:"kizyutsu", title:"Q56", text:"初代ボンゴレファミリーで霧の守護者を務めた人物の名前は？",                 media:null, audio:null, answer:"デイモン・スペード", answers:"デイモン・スペード,D・スペード,デイモンスペード,デイモン,スペード",                   nagaoType:"未分類", explanation:null },
      ...
      { id:60, type:"kizyutsu", title:"Q60", text:"フータ・デッレ・ステッレの特技は、あらゆる物事に何をつけることか？",         media:null, audio:null, answer:"ランキング",     answers:"ランキング",                                      nagaoType:"未分類", explanation:null },
      { id:61, type:"kizyutsu", title:"Q61", text:"イーピンの出身はどこの国？",                                               media:null, audio:null, answer:"中国",           answers:"中国,ちゅうごく",                                 nagaoType:"未分類", explanation:null },
      { id:62, type:"kizyutsu", title:"Q62", text:"綱吉の母親の名前は？",                                                     media:null, audio:null, answer:"沢田奈々",           answers:"沢田奈々,奈々,なな,ナナ",                                            nagaoType:"未分類", explanation:null },
      { id:63, type:"kizyutsu", title:"Q63", text:"綱吉の父親の名前は？",                         media:null, audio:null, answer:"沢田家光",       answers:"沢田家光,家光,いえみつ,イエミツ",                                        nagaoType:"未分類", explanation:null },
      { id:67, type:"kizyutsu", title:"Q67", text:"笹川京子の親友の名前は？",                                                 media:null, audio:null, answer:"黒川花",       answers:"黒川花,くろかわはな,ハナ,花,はな,黒川,くろかわ",                     nagaoType:"未分類", explanation:null },
      { id:68, type:"kizyutsu", title:"Q68", text:"シモン一族の末裔にあたる転校生のボスの名前は？",       media:null, audio:null, answer:"古里炎真",         answers:"古里炎真,炎真,エンマ,えんま",                                          nagaoType:"未分類", explanation:null },
      { id:71, type:"kizyutsu", title:"Q71", text:"綱吉たちを未来へ送った実は味方だった人物の名前は？",             media:null, audio:null, answer:"入江正一",       answers:"入江正一,いりえしょういち,正一",                 nagaoType:"未分類", explanation:null },
      { id:72, type:"kizyutsu", title:"Q72", text:"X BURNERを完成させるため、コントタクトレンズを作成したの名前は？",                     media:null, audio:null, answer:"スパナ",       answers:"スパナ",                                        nagaoType:"未分類", explanation:null },
      ...
      { id:27, type:"kizyutsu", title:"Q27", text:"ヴァリアーで「雲」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"雲雀恭弥",       answers:"雲雀恭弥,ひばりきょうや,雲雀",                   nagaoType:"未分類", explanation:null },
      { id:28, type:"kizyutsu", title:"Q28", text:"ヴァリアーで「嵐」の役割を担うキャラクターは誰？",                 media:null, audio:null, answer:"ベルフェゴール",       answers:"ベルフェゴール,ベル",                        nagaoType:"未分類", explanation:null },
      { id:29, type:"kizyutsu", title:"Q29", text:"ヴァリアーで「雨」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"スクアーロ",         answers:"スクアーロ",                          nagaoType:"未分類", explanation:null },
      { id:65, type:"kizyutsu", title:"Q65", text:"ヴァリアーで「晴」の役割を担うキャラクターは誰？",                         media:null, audio:null, answer:"ルッスーリア",       answers:"ルッスーリア",               nagaoType:"未分類", explanation:null },
      { id:30, type:"kizyutsu", title:"Q30", text:"ヴァリアーで「雷」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"レヴィ・ア・タン",         answers:"レヴィ・ア・タン,レヴィ",                                          nagaoType:"未分類", explanation:null },
      { id:30, type:"kizyutsu", title:"Q30", text:"ヴァリアーで「霧」の役割を担うキャラクターは誰？（ヴァリアーでの名前で）",                   media:null, audio:null, answer:"マーモン",         answers:"マーモン",                                          nagaoType:"未分類", explanation:null },
      { id:27, type:"kizyutsu", title:"Q27", text:"アルコバレーノで初代「大空」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"ルーチェ",       answers:"ルーチェ",                   nagaoType:"未分類", explanation:null },
      { id:27, type:"kizyutsu", title:"Q27", text:"アルコバレーノで「雲」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"スカル",       answers:"スカル",                   nagaoType:"未分類", explanation:null },
      { id:28, type:"kizyutsu", title:"Q28", text:"アルコバレーノで「嵐」の役割を担うキャラクターは誰？",                 media:null, audio:null, answer:"風（フォン）",       answers:"風（フォン）,風,フォン",                        nagaoType:"未分類", explanation:null },
      { id:29, type:"kizyutsu", title:"Q29", text:"アルコバレーノで「雨」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"コロネロ",         answers:"コロネロ",                          nagaoType:"未分類", explanation:null },
      { id:65, type:"kizyutsu", title:"Q65", text:"アルコバレーノで「晴」の役割を担うキャラクターは誰？",                         media:null, audio:null, answer:"リボーン",       answers:"リボーン",               nagaoType:"未分類", explanation:null },
      { id:30, type:"kizyutsu", title:"Q30", text:"アルコバレーノで「雷」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"ヴェルデ",         answers:"ヴェルデ",                                          nagaoType:"未分類", explanation:null },
      { id:30, type:"kizyutsu", title:"Q30", text:"アルコバレーノで「霧」の役割を担うキャラクターは誰？",                   media:null, audio:null, answer:"バイパー",         answers:"バイパー",                                          nagaoType:"未分類", explanation:null },
      { id:83, type:"kizyutsu", title:"Q83", text:"初代「大空」のアルコバレーノの娘であり、現在の大空の母親であるの名前は？",         media:null, audio:null, answer:"アリア",           answers:"アリア",                                            nagaoType:"未分類", explanation:null },
      { id:83, type:"kizyutsu", title:"Q83", text:"ジッリョネロファミリーのボスであり、アルコバレーノ達を生き返らせるため亡くなった人物は？",         media:null, audio:null, answer:"ユニ",           answers:"ユニ",                                            nagaoType:"未分類", explanation:null },
      { id:89, type:"kizyutsu", title:"Q89", text:"ブーメランを武器とする青い色のハイパー死ぬ気モードで戦う人物名前は？",         media:null, audio:null, answer:"バジル",         answers:"バジル",                                          nagaoType:"未分類", explanation:null },
      ...
      { id:99, type:"kizyutsu", title:"Q99", text:"綱吉のボックス武器であるライオンの名前は？",                               media:null, audio:null, answer:"ナッツ",           answers:"ナッツ",                                            nagaoType:"未分類", explanation:null },
      { id:100,type:"kizyutsu", title:"Q100",text:"獄寺隼人のボックス武器である猫の名前は？",                                 media:null, audio:null, answer:"瓜",           answers:"瓜,うり,ウリ",                                            nagaoType:"未分類", explanation:null },
      { id:101,type:"kizyutsu", title:"Q101",text:"山本武のボックス武器である犬の名前は？",                                   media:null, audio:null, answer:"次郎",           answers:"次郎,じろう,雨犬",                                     nagaoType:"未分類", explanation:null },
      { id:101,type:"kizyutsu", title:"Q101",text:"山本武のボックス武器であるツバメの名前は？",                                   media:null, audio:null, answer:"小次郎",           answers:"小次郎,こじろう,雨ツバメ",                                     nagaoType:"未分類", explanation:null },
      { id:103,type:"kizyutsu", title:"Q103",text:"ディーノが率いる一族の名前は？",                                           media:null, audio:null, answer:"キャバッローネファミリー", answers:"キャバッローネファミリー,キャバッローネ",       nagaoType:"未分類", explanation:null },
